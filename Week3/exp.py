...
class Zoo:
    ...
    def get_groups(self, group):
        return self.sort_animals()[group]
    
ramat_gan_safari = Zoo('ZooZoo')
alist = ['kkk','jjj','iii','ahhh','ggg','fff','eee','ddd','ccc','bbb','aaa']
for a in alist: 
    ramat_gan_safari.add_animal(a)

print(f'get_animals = {ramat_gan_safari.get_animals()}')
print(f'sort_animals = {ramat_gan_safari.sort_animals()}')
print(f'sell_animal = {ramat_gan_safari.sell_animal('bbb')}')
print(f'get_animals = {ramat_gan_safari.get_animals()}')
print(f'sort_animals = {ramat_gan_safari.sort_animals()}')
print(f'get_groups = {ramat_gan_safari.get_groups(2)}')
